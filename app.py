...
def upload_file():
    ...
    if file and file.filename.endswith('.csv'):
        ...
        for _, row in df.iterrows():
            employee_row = EmployeeData(date=row['date'], hours_worked=row['hours worked'], employee_id=row['employee id'], job_group=row['job group'])
...
def get_payroll_report():
    ...
    # Define hourly rates for job groups
    hourly_rates = {
        'A': 20.00,
        'B': 30.00
    }
